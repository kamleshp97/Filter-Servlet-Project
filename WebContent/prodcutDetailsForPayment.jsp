	...
	<div>
		<div class="card m-3">
		  ...
		  <div class="card-body ml-4">
		    ...
		    <p class="card-text">
		    	<small class="text-muted">Quantity: ${PRODUCT.PRODUCTQUANT} </small>
		    </p>
		    <br> <br> <br> 
		   <form method="post" action="paymentGatway">
		  	<input type="text" style="display: none" name="productId" value="${PRODUCT.PRODUCTID}"/>
		  	<input type="text" style="display: none" name="productPrice" value="${PRODUCT.PRODUCTPRICE}"/>
